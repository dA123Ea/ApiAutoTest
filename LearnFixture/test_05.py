...
data=[{"data":{"mobilephone":"18709183930","pwd":"123456"},"expect":{"msg":"手机号码已被注册","status":"0","code":"20110"}},
      {"data":{"mobilephone": "18709183931", "pwd": "123"},"expect":{"msg":"密码长度必须为6~18","status":"0","code":"20108"}}]

@pytest.fixture(params=data)
def register_data(request):   #request 是fixture中的关键字
    return request.param      #通过request。param 获取每一组测试数据
